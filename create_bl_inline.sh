...
if not frappe.db.exists('DocType', 'Bill of Lading Container'):
    container_doc = frappe.get_doc({
        ...
        'editable_grid': 1,
        'fields': [
            {'fieldname': 'container_number', 'fieldtype': 'Data', 'label': 'Container Number', 'in_list_view': 1, 'reqd': 1},
            {'fieldname': 'container_type', 'fieldtype': 'Select', 'label': 'Container Type', 'options': "20' Standard\n40' Standard\n40' High Cube\n45' High Cube\n20' Refrigerated\n40' Refrigerated\n20' Open Top\n40' Open Top\n20' Flat Rack\n40' Flat Rack", 'in_list_view': 1},
            {'fieldname': 'seal_number', 'fieldtype': 'Data', 'label': 'Seal Number', 'in_list_view': 1},
            {'fieldname': 'column_break_1', 'fieldtype': 'Column Break'},
            {'fieldname': 'packages', 'fieldtype': 'Int', 'label': 'Number of Packages', 'in_list_view': 1},
            {'fieldname': 'weight', 'fieldtype': 'Float', 'label': 'Weight (KG)', 'in_list_view': 1},
            {'fieldname': 'volume', 'fieldtype': 'Float', 'label': 'Volume (CBM)'}
        ]
    })
