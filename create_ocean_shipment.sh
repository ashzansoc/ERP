...
# Create Ocean Shipment DocType for Import/Export tracking

echo "🚢 Creating Ocean Shipment & Container Tracking Module..."

docker compose exec backend bench --site localhost execute frappe.commands.utils.add_custom_field << 'PYTHON_EOF'
import frappe
...
echo ""
echo "✅ Ocean Shipment & Container Tracking module installed!"
echo ""
echo "Access it at: Desk → Stock → Ocean Shipment"
