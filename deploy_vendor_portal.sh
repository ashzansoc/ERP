...
# Quick deployment script for Vendor Portal
set -e

echo "🌍 Deploying Vendor & Freight Forwarder Portal..."

# Copy API files
echo "📦 Copying API files..."
docker cp api/vendor_portal.py frappe_docker-backend-1:/home/frappe/frappe-bench/apps/erpnext/erpnext/buying/
docker cp api/freight_portal.py frappe_docker-backend-1:/home/frappe/frappe-bench/apps/erpnext/erpnext/stock/

# Create DocTypes using bench console
echo "🔧 Creating DocTypes..."
docker compose -f frappe_docker/compose.yaml exec -T backend bench --site localhost run-python-script << 'PYTHON_SCRIPT'
import frappe
...
custom_fields = {
    "Supplier": [
        {
            "fieldname": "portal_access_section",
            "label": "Portal Access",
        ...
        },
        {
            ...
            "fieldtype": "Check",
            "insert_after": "portal_access_section"
        },
        {
...
print("✓ Added custom fields to Supplier")
...
echo ""
echo "📋 Portal Features Installed:"
echo "  • Vendor Document Log"
echo "  • Freight Quote"
echo "  • Shipment Milestone"
echo "  • Custom fields on Supplier"
echo ""
echo "🌐 Access your ERP at: http://localhost:8080"
echo ""
echo "📚 Next Steps:"
echo "  1. Go to Supplier list and enable Portal Access"
echo "  2. Create portal users and link to suppliers"
echo "  3. Test document upload and quote submission"
echo ""
