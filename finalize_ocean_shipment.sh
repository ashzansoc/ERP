...
echo "🚢 Finalizing Ocean Shipment Module Installation..."

# Add remaining fields to Ocean Shipment Container
docker compose exec backend bench --site localhost execute "
...
if not frappe.db.exists('DocType', 'Ocean Shipment'):
    doc = frappe.get_doc({
        ...
        'fields': [
            ...
            {'fieldname': 'column_break_2', 'fieldtype': 'Column Break'},
            {'fieldname': 'etd', 'fieldtype': 'Datetime', 'label': 'ETD', 'reqd': 1},
...
echo ""
echo "✅ Ocean Shipment Module Installation Complete!"
echo ""
echo "📍 Access it at: http://localhost:8080"
echo "   Navigate to: Desk → Stock → Ocean Shipment"
echo ""
echo "🎯 Features:"
